 ...
 */
const SCHEDULES = {
  "17 3 * * *": ["trash-cleanup", "inactivity", "abandoned-uploads", "orphan-sweep", "subscription-expiry"],
  ...
  // Crypto payments a webhook missed are picked up within the hour.
  "43 * * * *": ["storage-purge", "crypto-reconcile"],
};
